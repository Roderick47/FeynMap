...
class FeynMapEngine:
    ...
    def analyze(self, project_path: str, language: str = "auto", framework: str = "auto") -> SemanticGraph:
        ...
        source_scope = python_source_session(root)
        source_scope.__enter__()
        try:
            ...
            for language_score, language_adapter in language_choices:
                ...
                if language_adapter.name == "python":
                    graph = enrich_python_reexports(graph, root)
            ...
            if len(analyzed) == 1:
                ...
                for key in (
                    ...
                    "language_adapter",
                    "framework_adapter",
                    "framework_detection_score",
                    "framework_detection_scores",
                    "python_reexport_resolution",
                    "python_attribute_resolution",
                ):
            ...
            source_scope.__exit__(None, None, None)
